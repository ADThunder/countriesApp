...
export default function CountryDetailPage({
  ...
  const { isLoading, data } = useQuery<CountryProp[]>("countryByName", () =>
    ...
    <div>
      ...
      <section className="mt-8 flex flex-col items-center lg:flex-row gap-4 lg:gap-12 overflow-hidden">
        ...
        <div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 md:mt-5 md:gap-4 md:text-xl">
...
function CountryMap({ maps }: { maps: Maps }) {
  return (
    <div className="flex gap-1 ">
      ...
      <ValueSpan className="flex gap-2 ">
        :
        <Link
          target="_blank"
...
function CountryImage(country: CountryProp) {
  return (
    <div className="md:mb-8 mb-2  overflow-hidden w-[320px] h-[240px] md:w-[640px] md:h-[480px] drop-shadow-md  shadow-md ">
      <Image
        height={480}
        width={640}
